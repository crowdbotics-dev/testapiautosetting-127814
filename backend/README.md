...
## Project Structure
    ...
    ├── testapiautosetting_127814  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127814`
...
2. Clone this repo and `cd testapiautosetting_127814`
